...
public class UserCategoryController {
    ...
    @PostMapping()
    public ResponseEntity<UserCategoryResponse> createUserCategory(@RequestBody @Valid UserCategoryRequest request, @AuthenticationPrincipal CustomOAuth2User principal){
